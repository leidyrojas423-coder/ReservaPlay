...
export default function HomePage() {
  ...
  return (
    <section 
      ...
      aria-label="Bienvenida ReservaPlay"
    >

      <div 
        className="welcome-hero__background" 
        aria-hidden="true"
      >
      ...
      <div className="welcome-hero__content">
        ...
        <div className="welcome-hero__main">
          ...
          <p className="welcome-hero__eyebrow">
            Tu partido empieza aquí
          </p>


          <h2 className={`welcome-hero__title ${sportsTitleFont.className}`}>
            ReservaPlay
          </h2>


          <p className="welcome-hero__description">
            Gestiona y reserva canchas en segundos.
            Consulta horarios disponibles, organiza tus
            partidos y mantén el control total desde un
            panel administrativo claro y eficiente.
          </p>
          ...
          <div className="welcome-flags">
            ...
            <span className="welcome-flags__label">
              Reserva simple, juego asegurado
            </span>
            ...
            <ul className="welcome-flags__list">
              ...
              {countries.map((country) => (
                ...
                >
                  ...
                  <span 
                    className={`flag-badge ${country.className}`}
                  />
          ...
          <div className="welcome-hero__actions">
            ...
            <Link
              href="/mis-reservas"
              className="welcome-button welcome-button--cta"
            >
              Mis Reservas
            </Link>
        ...
        <aside 
          className="welcome-hero__side"
          aria-label="Resumen visual de ReservaPlay"
        >
          ...
          <div className="welcome-scoreboard">
            ...
            <p className="welcome-scoreboard__label">
              Partido listo
            </p>
            ...
            <div className="welcome-scoreboard__row">
              ...
              <div>
                ...
                <span className="welcome-scoreboard__number">
                  24/7
                </span>

                <p>
                  Consulta de horarios disponible en cualquier momento.
                </p>
              ...
              <div>
                ...
                <p>
                  Flujos clave para reservas, canchas y administración.
                </p>
          ...
          <div className="welcome-hero__highlights">
            ...
            <article className="highlight-card">
              ...
              <p>
                Visualiza horarios por cancha y evita cruces al crear nuevas reservas.
              </p>
            ...
            <article className="highlight-card">
              ...
              <p>
                Administra canchas, horarios y usuarios en un flujo centralizado.
              </p>
            ...
            <article className="highlight-card">
              ...
              <p>
                Menos pasos, menos errores y más tiempo para jugar.
              </p>
