...
export class CanchasController {
  ...
  async create(
    ...
    return this.canchasService.create(
      createCanchaDto
    );
  ...
  async findDisponibles() {
    ...
    return this.canchasService.consultarDisponibilidad({
  ...
  async consultarDisponibilidad(
    @Query() filtros: DisponibilidadCanchaDto
  ) {
  ...
  async update(
    ...
    return this.canchasService.update(
      id,
      updateCanchaDto
    );
